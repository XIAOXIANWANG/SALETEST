...
//            newPrice.font = [UIFont systemFontOfSize:17];
            ...
            oldPriceLabel.textColor = xnavigationBarColor;
...
+ (instancetype)RushCellinitWithTableView:(UITableView*)tableView{
    
    static NSString *ID=@"Rushcell_ID";
    
    RushCell *cell=[tableView dequeueReusableCellWithIdentifier:ID];
